...
class CategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        if(empty($request->input('data'))||$request->input('data')=='undefined' ||$request->input('data')=='')
        {
            ...
            // $categories = CategoryDesc::with('category.subCategories.categoryDesc','category.subCategories.catProperties.properties.propertiesValue',
            // 'category.catOption','category.catOption.catOptionDesc','category.catProperties.properties.propertiesValue')
            // ->get();
