...
<script>
    ...
    var memberID = [1, 2, 3]; // Replace with your selected account IDs
    var message = 'New notification message.'; // Replace with your notification message
    ...
    memberID.forEach(function(memberID) {
        var channel = pusher.subscribe('member.' + mem_id);
